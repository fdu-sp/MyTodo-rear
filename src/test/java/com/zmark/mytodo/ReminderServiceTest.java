...
public class ReminderServiceTest {
    ...
    public static final Date createDate1 = Date.valueOf("2024-03-25");
    ...
    public static final Date createDate2 = Date.valueOf("2024-03-26");
    public static final Timestamp createTimeStamp2 = new Timestamp(createDate2.getTime());
    public static final Timestamp remindTimeStamp2 = new Timestamp(Date.valueOf("2024-04-05").getTime());
    public static final Date createDate3 = Date.valueOf("2024-03-27");
    public static final Timestamp createTimeStamp3 = new Timestamp(createDate3.getTime());
    public static final Timestamp remindTimeStamp3 = new Timestamp(Date.valueOf("2024-04-11").getTime());
    ...
    public static final Timestamp remindTimeStamp4 = new Timestamp(Date.valueOf("2024-04-11").getTime());
    ...
    public static final Timestamp remindTimeStamp5 = new Timestamp(Date.valueOf("2024-04-11").getTime());

    public static final Date expectedExecutionDate = Date.valueOf("2024-04-12");
    public static final Date endDate = Date.valueOf("2024-04-12");
